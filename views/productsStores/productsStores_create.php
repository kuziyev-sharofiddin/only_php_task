...
<div class="app-container container-lg  pt-10">
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                        <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/views/productsStores/productsStores_show.php">
                                    Product Store List
                                </a>
                            </li>
                            <li class="breadcrumb-item">
    ...
    <div class="card card-flush p-10">
        <form id="kt_docs_formvalidation_text" class="form fv-plugins-bootstrap5 fv-plugins-framework"
            action="/Controller/ProductsStores.php" method="POST">
            ...
            <div class="fv-row mb-10 row fv-plugins-icon-container">
                <div class="col-3 d-flex align-items-center justify-content-end">
                    <label for="storeSelect" class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        <span class="required">Select Store</span>
                    </label>
                </div>
                <div class="col-7">
                    <select name="store_id" id="storeSelect" data-control="select2" data-placeholder="Select..."
                        class="form-select form-select-solid mb-3 mb-lg-0">
