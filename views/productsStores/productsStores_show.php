...
require_once __DIR__ . '/../../Controller/ProductsStores.php';
?>
<div class="app-container container  pt-10">
    <div class="content-header row mb-6">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-4">Product Stores</h2>
    ...
    <div class="card card-body p-10">
        <div class="d-flex flex-stack mb-5 ">
            ...
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                <a href="/views/productsStores/productsStores_create.php" class="btn btn-primary btn-sm">
            ...
            <div class="table-responsive">
                <table id="categories_datatable"
                    ...
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                ...
                                <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Category Name</th>
                    ...
                    <?php foreach ($productsStores as $productsStore): ?>
                        <tr class="even">
                            <td><?=$productsStore['id']?></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$productsStore['product_name']?></a></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$productsStore['store_name']?></a></td>
                            <td>
                                <div class="text-end">
                                    <div class="btn-group">
                                        <a href="productsStores_edit.php?id=<?=$productsStore['id']?>" class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                            <i class="bi bi-pencil p-0"></i>
                                        </a>
                                        <a href="/Controller/ProductsStores.php?id=<?=$productsStore['id']?>&delete" class="btn btn-danger btn-sm px-4 delete" data-id="27">
