...
?> 
    <div class="app-container container-lg  pt-10">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                            <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/views/store/store_show.php">
                                        Store
                                    </a>
                                </li>
                                <li class="breadcrumb-item">
        ...
        <div class="card card-flush p-10">
            <form id="kt_docs_formvalidation_text" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="/Controller/Store.php?id=<?=$store['id']?>" method="POST">
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    <div class="col-3 d-flex align-items-center justify-content-end">
                        <label class="required fw-semibold fs-6 mb-2">Name</label>
                    </div>
                    <div class="col-7">
                        <input type="text" name="name" value="<?=$store['name']?>" class="form-control form-control-solid mb-3 mb-lg-0">
