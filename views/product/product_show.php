...
<div class="app-container container  pt-10">
    ...
    <div class="card card-body p-10">
        <div class="d-flex flex-stack mb-5 ">
            ...
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                <a href="/views/product/product_create.php" class="btn btn-primary btn-sm">
            ...
            <div class="table-responsive">
                <table id="categories_datatable"
                    ...
                    <?php foreach ($products as $product): ?>
                        <tr class="even">
                            <td><?=$product['id']?></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$product['name']?></a></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$product['category_name']?></a></td>
                            <td>
                                <div class="text-end">
                                    <div class="btn-group">
                                        <a href="product_edit.php?id=<?=$product['id']?>" class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                            <i class="bi bi-pencil p-0"></i>
                                        </a>
                                        <a href="/Controller/Product.php?id=<?=$product['id']?>&delete" class="btn btn-danger btn-sm px-4 delete" data-id="27">
