...
<div class="app-container container  pt-10">
    ...
    <div class="card card-body p-10">
        <div class="d-flex flex-stack mb-5 ">
            ...
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                <a href="/views/productIncome/productIncome_create.php" class="btn btn-primary btn-sm">
        ...
        <div id="categories_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
            <div class="table-responsive">
                <table id="categories_datatable"
                    ...
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                ...
                                style="width: 225.25px;">Count</th>
                                <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Product Name</th>
                                <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Selling Price</th>
                                <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Getting Price</th>
                                <th class="w-225px sorting" tabindex="0" aria-controls="categories_datatable" rowspan="1"
                                colspan="1" aria-label="Nomi: activate to sort column ascending"
                                style="width: 225.25px;">Date</th>
                    ...
                    <?php foreach ($productIncomes as $productIncome): ?>
                        <tr class="even">
                            <td><?=$productIncome['id']?></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$productIncome['count']?></a></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$productIncome['product_name']?></a></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$productIncome['selling_price']?></a></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$productIncome['income_price']?></a></td>
                            <td><a href="?parent_id=27" class="text-hover-primary text-gray-800"><?=$productIncome['date']?></a></td>
                            <td>
                                <div class="text-end">
                                    <div class="btn-group">
                                        <a href="productIncome_edit.php?id=<?=$productIncome['id']?>" class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                            <i class="bi bi-pencil p-0"></i>
                                        </a>
                                        <a href="/Controller/ProductIncome.php?id=<?=$productIncome['id']?>&delete" class="btn btn-danger btn-sm px-4 delete" data-id="27">
