...
<div class="app-container container-lg  pt-10">
    ...
    <div class="card card-flush p-10">
        <form id="kt_docs_formvalidation_text" class="form fv-plugins-bootstrap5 fv-plugins-framework"
            action="/Controller/ProductIncome.php" method="POST">
            ...
            <div class="fv-row mb-10 row fv-plugins-icon-container">
                ...
                <div class="col-7">
                    <input type="text" name="count" value="" class="form-control form-control-solid mb-3 mb-lg-0">
            ...
            <div class="fv-row mb-10 row fv-plugins-icon-container">
                ...
                <div class="col-7">
                    <input type="text" name="selling_price" value="" class="form-control form-control-solid mb-3 mb-lg-0">
                    <div class="fv-plugins-message-container invalid-feedback">
                    </div>
                </div>
            </div>
            <div class="fv-row mb-10 row fv-plugins-icon-container">
                ...
                <div class="col-7">
                    <input type="text" name="income_price" value="" class="form-control form-control-solid mb-3 mb-lg-0">
                    <div class="fv-plugins-message-container invalid-feedback">
                    </div>
                </div>
            </div>
            <div class="fv-row mb-10 row fv-plugins-icon-container">
                ...
                <div class="col-7">
                    <input type="date" name="date" value="" class="form-control form-control-solid mb-3 mb-lg-0">
                    <div class="fv-plugins-message-container invalid-feedback">
                    </div>
                </div>
            </div>
